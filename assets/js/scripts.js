...
function play(DEVICE_ID, URIS) {
  callApi("PUT", "https://api.spotify.com/v1/me/player/play?device_id=" + DEVICE_ID, URIS, handleApiResponse);
}

function pause(DEVICE_ID) {
  callApi("PUT", "https://api.spotify.com/v1/me/player/pause?device_id=" + DEVICE_ID, null, handleApiResponse);
}

// function currentlyPlaying() {
//   callApi("GET", "https://api.spotify.com/v1/me/player/currently-playing", null, handleCurrentlyPlaying);
// }

function skip(DEVICE_ID) {
  callApi("POST", "https://api.spotify.com/v1/me/player/next?device_id=" + DEVICE_ID, null, handleApiResponse);
}

function getPlaylist() {
  callApi("GET", "https://api.spotify.com/v1/playlists/0Me1ANsc8Kmz1cUNdpLK3v", null, handleGetPlaylist);
}
...
//   if (this.status == 200) { // Something is playing
//     var data = JSON.parse(this.responseText);
